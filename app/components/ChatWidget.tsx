          ...
          <div className="p-4 border-t border-gray-800">
            <div className="flex gap-2 items-end">
              <textarea
                ...
                className="flex-1 px-4 py-3 bg-gray-800 text-white rounded-lg border border-gray-700 focus:border-[var(--accent-purple)] focus:outline-none resize-none disabled:opacity-50"
              ...
              <button
                ...
                className="p-3 bg-[var(--accent-purple)] text-white rounded-lg hover:bg-[var(--accent-purple-hover)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
